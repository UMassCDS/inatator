    ...
    <div className="instruction-container">
      ...
      {isOpen && (
        <div className="instructions">
          <h3>Instructions</h3>
          <p>
            1. To start the annotation, please select a <b>Taxa Name</b> in the
            left menu.
          </p>
          <p>
          ...
          <ol>
            <li>
              ...
              : Clicking this button sends a request to the model, which returns
              predictions.
              <p>
                These predictions can be viewed in several formats (selected in
                the <u>upper right corner of the map</u>):
              </p>
              <ul>
                <li>
                ...
                <li>
                  ...
                  will be populated with <b style={{ color: "#e14b23" }}>red</b>{" "}
                  hexagons when adding <b>absence</b> species annotations.
                </li>

                <li>
                  <strong>Prediction Hexagons</strong>: Predictions in the form
                  of hexagons (<b style={{ color: "#4eaee4" }}>blue</b> color).{" "}
                  <b>Not editable</b>.
                </li>
              </ul>
              Additional layers:
            ...
            <li>
              ...
              <p>
                Before clicking this button, make sure that the annotation looks
                correct for the selected Taxa.
              </p>
            </li>
            <br />
            <li>
          ...
          <p>
            A selection/drawing tool allows you to draw either a rectangle or a
            polygon:
          </p>
          <ul>
            <li>
