...
const Sidebar = forwardRef((props, ref) => {
  ...
  return (
    <div className="sidebar">
      ...
      <input type="number" step="0.01" id="threshold" defaultValue="0.1" min="0.1" max="0.9" ref={ref.threshold} />

      <label htmlFor="hexResolution">Hex Resolution:</label>
      <input type="number" id="hexResolution" defaultValue="4" min="0" max="15" ref={ref.hexResolution} />
